document.addEventListener('DOMContentLoaded', function () {
    ...
    workExperienceDiv === null || workExperienceDiv === void 0 ? void 0 : workExperienceDiv.addEventListener('input', function (event) {
        var updatedWorkExperience = event.target.innerText;
    });
});
